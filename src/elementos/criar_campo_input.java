...
public class criar_campo_input {
    ...
    private String prefixo_painel_criar_campo_input = "painel_criar_campo_input_";
        ...
        btn_aplicar.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                if( !nome_titulo.isEmpty() )
                {
                    ...
                    operacoes_painel.add_componente_painel_baixo_e_add_botao_exluir(p_int, painel_baixo, pos_painel_baixo, prefixo_painel_criar_campo_input);
