...
//                        campos.setText("");
    ...
    {
        final String name_painel_radios = operacoes.gerar_name_para_componente(prefixo_painel_select);
        ...
        public void actionPerformed(ActionEvent ae) {
                ...
                painel_baixo.remove( operacoes_painel.pegar_componente_em_painel(painel_baixo, operacoes.pegar_name(prefixo_painel_select, chave_painel)) );
